                        ...
                        <div class="carousel-inner border">
                            ...
                            @foreach ($product->images as $image)
                                <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                    <img class="w-100 h-100" style="width: 100% !important; height: 381px !important; object-fit: contain;"  src="{{ $image->image_url }}" alt="Image">
                                </div>
                            @endforeach
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <a class="btn btn-primary px-3 text-white" target="_blank"
                            href="https://wa.me/51956428239?text=Quisiera más información del producto - Codigo:{{ $product->id }} - {{ $product->descripcion }}"
                        ...
                        @foreach ($products as $product)
                            <div class="card product-item border-0">
                                <div
                                    ...
                                    <img class="img-fluid w-100" style="width: 100% !important; height: 381px !important; object-fit: contain;"
